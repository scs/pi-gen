...
wget \
    ...
    "https://github.com/scs/smartmeter-datacollector/releases/download/v0.6.1/python3-smartmeter-datacollector_0.6.1-1_armhf.deb"

# Download Smart Meter Data Collector Configurator
wget \
    -O "${ROOTFS_DIR}/tmp/python3-smartmeter-datacollector-configurator.deb" \
    "https://github.com/scs/smartmeter-datacollector-configurator/releases/download/v0.4.1/python3-smartmeter-datacollector-configurator_0.4.1-1_armhf.deb"
